...
<HTML>
	<HEAD>
		...
		<!-- --><link rel="stylesheet" href="<?php bloginfo ('stylesheet_directory'); ?>/bootstrap-4.3.1/scss/bootstrap.css" type="text/css" /><!-- --><!-- use custom bootstrap -->
	...
	<BODY>
		<nav class="navbar navbar-expand-lg navbar-frill bg-frill fixed-top">
